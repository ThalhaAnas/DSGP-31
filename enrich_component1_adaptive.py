...
# FILE PATHS (ADAPTIVE SYSTEM)

NETWORK_FILE = "component1_network_adaptive.csv"
TRIPINFO_FILE = "tripinfo_adaptive.xml"
ROUTE_FILE = "simulation_map.rou.xml"
OUTPUT_FILE = "component1_enriched_adaptive.csv"

print("🟢 Enriching Component 1 (ADAPTIVE)...")
...
df["system_type"] = "adaptive"

# SAVE OUTPUT

df.to_csv(OUTPUT_FILE, index=False)

print("✅ Component 1 ADAPTIVE enrichment complete")
